      ...
      <View style={styles.container}>
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity onPress={() => this.props.navigation.openDrawer()}>
            <Image
              source={require("../../../assets/img/menu-button-of-three-horizontal-lines.png")}
              style={styles.img}
            />
          </TouchableOpacity>
        ...
        />
        <TouchableOpacity
          style={{ marginLeft: 350, marginBottom: 15 }}
          onPress={() => this.props.navigation.navigate("CadastrarTarefas")}
        >
          <Image
    ...
    return (
      <View style={styles.flatList}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          >
            <Image
              source={require("../../../assets/img/x-button.png")}
